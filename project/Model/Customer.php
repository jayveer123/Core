...
class Model_Customer extends Model_Core_Row
{
	...
	{
		return Ccc::getModel('Core_View')->getUrl('edit','customer',['id'=>$this->id]);
	}

	public function getDeleteUrl()
	{
		return Ccc::getModel('Core_View')->getUrl('delete','customer',['id'=>$this->id]);
	}

	public function getPriceUrl()
	{
		return Ccc::getModel('Core_View')->getUrl('grid','customer_price',['id' => $this->id]);
	}
