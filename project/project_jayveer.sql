...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2022 at 07:33 AM
...
(23, 'admin', 'admin', 'admin@admin.com', '21232f297a57a5a743894a0e4a801fc3', 1, '2022-03-13 17:03:45', '0000-00-00 00:00:00');
...
(257, NULL, 'Bedrroom', 1, '257', 66, 66, NULL, '2022-03-16 11:03:18', NULL);
...
(66, 257, 'Screenshot_(12)20220316065023.png', 0),
(67, 257, 'Screenshot_(23)20220316065027.png', 0);
...
(210, 12, 'aa', 'aa', 'a@g.com', 123456, 1, '2022-03-15 10:03:19', '2022-03-21 12:28:08'),
(211, 12, 'aa', 'aa', 'a@g.com', 123456789, 1, '2022-03-15 10:03:19', '2022-03-21 12:28:17'),
(213, NULL, 'qq', 'qq', 'q@g.com', 789456123, 1, '2022-03-15 10:03:10', '2022-03-21 12:28:27');
...
(55, 210, 'Deo', 123456, 'DEMo', 'Demo', 'Demo', 1, 2),
(56, 210, 'Deo', 123456, 'DEMo', 'Demo', 'Demo', 2, 1),
(57, 211, 'demo', 789456, 'JJ', 'jJ', 'JJ', 1, 2),
(58, 211, 'demo', 789456, 'JJ', 'jJ', 'JJ', 2, 1),
(59, 213, 'bbbbbb', 101010, 'demo', 'QQ', 'QQ', 1, 2),
(60, 213, 'wwww', 505250, 'demo', 'QQ', 'QQ', 2, 1);
...
INSERT INTO `order_address` (`address_id`, `order_id`, `firstName`, `lastName`, `email`, `mobile`, `address`, `city`, `state`, `country`, `postal_code`, `billing`, `shipping`, `createdDate`) VALUES
(42, 83, 'qq', 'qq', 'q@g.com', 789456123, 'bbbbbb', 'demo', 'QQ', 'QQ', 101010, 1, 2, '2022-03-24 12:01:55'),
(43, 83, 'qq', 'qq', 'q@g.com', 789456123, 'wwww', 'demo', 'QQ', 'QQ', 505250, 2, 1, '2022-03-24 12:01:55');
...
INSERT INTO `order_data` (`order_id`, `customerId`, `firstName`, `lastName`, `email`, `mobile`, `taxAmount`, `discount`, `grandTotal`, `shippingId`, `shippingCharge`, `paymentId`, `state`, `status`, `createdDate`) VALUES
(83, 213, 'qq', 'qq', 'q@g.com', 789456123, 600, 1000, 9000, 2, 50, 2, 1, 1, '2022-03-24 12:01:55');
...
INSERT INTO `order_item` (`item_id`, `order_id`, `product_id`, `name`, `sku`, `price`, `tax`, `taxAmount`, `discount`, `quntity`, `createdDate`) VALUES
(43, 83, 134, 'AAA', 'AB001', 10000, 6, 600, 1000, 2, '2022-03-24 12:01:55');
...
INSERT INTO `product` (`id`, `p_name`, `p_price`, `tax`, `msp`, `cost_price`, `sku`, `discount`, `p_qun`, `p_stetus`, `base`, `small`, `thumb`, `createdDate`, `updatedDate`) VALUES
(134, 'AAA', 5000, 6, 4500, 4500, 'AB001', 500, 5, 1, 32, 32, 31, '2022-03-09 23:03:32', '2022-03-23 18:03:49'),
(137, 'ww', 5000, 5, 1000, 4000, 'DD002', 150, 123, 1, 36, NULL, NULL, '2022-03-21 09:03:35', '2022-03-24 11:03:32');
...
(31, 134, 'admin20220316084228.png', 0),
(32, 134, 'Screenshot_(19)20220316084233.png', 0),
(33, 134, 'Screenshot_(33)20220316084246.png', 0),
(34, 134, 'Screenshot_(31)20220316084251.png', 0),
(36, 137, 'adminside-first20220321052000.jpg', 0);
...
--
ALTER TABLE `category_media`
  MODIFY `imageId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
...
--
ALTER TABLE `product_media`
  MODIFY `imageId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
ALTER TABLE `order_data`
  ...
  ADD CONSTRAINT `fk_shippingId` FOREIGN KEY (`shippingId`) REFERENCES `shiping_method` (`method_id`) ON DELETE CASCADE ON UPDATE CASCADE;
