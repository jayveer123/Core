...
?>
	...
	<table border="1" width="100%" cellspacing="4">
		<button><a href="<?php echo $this->getUrl('add','vendor') ?>">Add New</a></button>
		<tr>
			<th>Id</th>
			<th>First Name</th>
			<th>Last Name</th>
		...
		<?php if($vendors){ ?>
			...
			<tr>
				...
				<td>
					<a href="<?php echo $this->getUrl('edit','vendor',['id'=>$vendor->id],true) ?>">Edit</a>
				</td>
				<td>
					<a href="<?php echo $this->getUrl('delete','vendor',['id'=>$vendor->id],true)?>">Delete</a>
				</td>
			<tr>
			<?php } ?>
		<?php }else{ ?>
