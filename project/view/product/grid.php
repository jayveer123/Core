...
<table align="center" border="1" width="100%">
	<button><a href="<?php echo $this->getUrl('add','product') ?>">Add New</a></button>
	<tr>
		<th>Product Id</th>
		<th>Product Name</th>
		<th>Product Price</th>
	...
	if($products){
		...
		<tr>
			...
			<td>
				<img src="<?php echo($product->base)?"Media/Product/".$product->getBase()->imageName : "";  ?>" alt="No Image Found" width="50" height="50">
			</td>

			<td>
				<img src="<?php echo($product->thumb)?"Media/Product/".$product->getThumb()->imageName : "";  ?>" alt="No Image Found" width="50" height="50">
			</td>

			<td>
				<img src="<?php echo($product->small)?"Media/Product/".$product->getSmall()->imageName : "";  ?>" alt="No Image Found" width="50" height="50">
			</td>

			<td><?php echo $product->createdDate; ?></td>
			<td><?php echo $product->updatedDate; ?></td>
			<td><a href="<?php echo $this->getUrl('edit','product',['id'=>$product->id],true) ?>">Edit</a></td>
			<td><a href="<?php echo $this->getUrl('delete','product',['id'=>$product->id],true) ?>">Delete</a></td>
			<td><a href="<?php echo $this->getUrl('grid','product_media',['id'=>$product->id],true) ?>">Media</a></td>
		</tr>
		<?php 
		$id++;
		}
