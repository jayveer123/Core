...
<form action="<?php echo $this->getUrl('saveCartAddress','cart'); ?>" method="post">
	<table border="1">
		<tr>
			...
			<td>
				<table border="1">
					...
					<tr>
						<td></td>
						<td>
							<input type="checkbox" name="sameAsShipint" id="sameaddress" onclick="same()">same as shiping address
							<br>
...
<table border="1">
	...
	<tr>
		<td>
			<form action="<?php echo $this->getUrl('savePaymentMethod','cart') ?>" method="post">
		...
		<td>
			<form action="<?php echo $this->getUrl('saveShippingMethod','cart') ?>" method="post">
...
<div id="productTable">
	<form action="<?php echo $this->getUrl('addCartItem','cart') ?>" method="post">
		<table border="1">
			<tr>
...
<br><br>
<form action="<?php echo $this->getUrl('cartItemUpdate','cart') ?>" method="post">
	...
	<form action="<?php echo $this->getUrl('placeOrder','cart') ?>" method="post">
		<table border="1">
			<tr>
				<td>Sub Total</td>
...
<script type="text/javascript">
	...
	function same() {
					var checkedBox = document.getElementById("sameaddress");
