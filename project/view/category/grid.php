...
<table align="center" border="1" width="100%">
	<button><a href="<?php echo $this->getUrl('add','category',[],true) ?>">Add New</a></button>
	<tr>
		<th>Category Id</th>
		<th>Category Name</th>
		<th>Category Path</th>
	...
	if($categories){
		...
		<tr>
			...
			<td><a href="<?php echo $this->getUrl('edit','category',['id'=>$category->id],true) ?>">Edit</a></td>
			<td><a href="<?php echo $this->getUrl('delete','category',['id'=>$category->id],true) ?>">Delete</a></td>
			<td><a href="<?php echo $this->getUrl('grid','category_media',['id'=>$category->id],true) ?>">Media</a></td>
		</tr>
		<?php 
