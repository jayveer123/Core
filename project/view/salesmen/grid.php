...
<h3 align="center">* Salesman Grid *</h3>
	<table border="1" width="100%" cellspacing="4">
		<button><a href="<?php echo $this->getUrl('add','salesmen') ?>">Add New</a></button>
		<tr>
			<th>Id</th>
			<th>First Name</th>
			<th>Last Name</th>
		...
		<?php if($salesmens){ ?>
			...
			<tr>
				...
				<td>
					<a href="<?php echo $this->getUrl('edit','salesmen',['id'=>$salesmen->id],true) ?>">Edit</a>
				</td>
				<td>
					<a href="<?php echo $this->getUrl('delete','salesmen',['id'=>$salesmen->id],true)?>">Delete</a>
				</td>
				<td>
					<a href="<?php echo $this->getUrl('grid','salesmen_salesmenCustomer',['id'=>$salesmen->id],true)?>">Assign Customer</a>
				</td>
