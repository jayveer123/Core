...
<form method="POST" action="<?php echo $this->getUrl('admin','save',['id'=>$admin->id],true) ?>">
	...
	<td><input type="radio" name="admin[stetus]" value="1" <?php if($admin->stetus==1){echo "checked";} ?>>Active</td>
	<td><input type="radio" name="admin[stetus]" value="2" <?php if($admin->stetus==2){echo "checked";}?>>DeActive</td>
	</tr>
