...
<h3 align="center">* Process Record With Customer *</h3>
	...
	<td><input type="radio" name="customer[stetus]" <?php if($customer->stetus==1){echo "checked";} ?> value="1">Active
	<input type="radio" name="customer[stetus]" <?php if($customer->stetus==2){echo "checked";} ?> value="2">DeActive</td>
	</tr>
